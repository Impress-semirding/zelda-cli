 ...
 * @Last modified time: 2017-09-06T11:30:18+08:00
* @License: MIT
...
function getValue(series) {
  if (_.first(series) && _.first(series).data) {
    return _.first(series).data.map(e => (e.value ? e.value : e));
  }
  return [];
}
...
export default function (option, data = {}) {
  ...
  return {
    ...
    yAxis: option.labelOnRight ? [{
      ...yAxis,
      data: labels || [],
    }, {
      ...yAxis,
      data: getValue(series),
      axisLabel: Object.assign({}, yAxis.axisLabel, {
        textStyle: {
          color: option.labelOnRightColor,
        },
      }),
    }] : {
      ...yAxis,
