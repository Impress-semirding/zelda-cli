...
export default class Resizable extends React.Component {
   ...
   * @param  {ResizeDirection} direction Resize drag direction
   * @return {Function}        Handler function.
   */
  resizeHandler(handlerName: string, direction?: ResizeDirection): Function {
    return (e: SyntheticEvent | MouseEvent, {node, deltaX, deltaY}: DragCallbackData) => {
      ...
      if (hasCb) {
        ...
        this.setState(newState, () => this.props[handlerName](e, {node, size: {width, height}}, direction));
      } else {
  ...
  render(): React.Element<any> {
    ...
    return cloneElement(children, {
      ...
      children: [
        ...
        <DraggableCore
          {...draggableOpts}
          key="resizableHandle-top-left"
          onStop={this.resizeHandler('onResizeStop')}
          onStart={this.resizeHandler('onResizeStart')}
          onDrag={this.resizeHandler('onResize', 'top-left')}
          >
          <span className="react-resizable-handle resize-top-left" />
        </DraggableCore>,
        <DraggableCore
          {...draggableOpts}
          key="resizableHandle-top-right"
          onStop={this.resizeHandler('onResizeStop')}
          onStart={this.resizeHandler('onResizeStart')}
          onDrag={this.resizeHandler('onResize', 'top-right')}
          >
          <span className="react-resizable-handle resize-top-right" />
        </DraggableCore>,
        <DraggableCore
          {...draggableOpts}
          key="resizableHandle-bottom-left"
          onStop={this.resizeHandler('onResizeStop')}
          onStart={this.resizeHandler('onResizeStart')}
          onDrag={this.resizeHandler('onResize', 'bottom-left')}
          >
          <span className="react-resizable-handle resize-bottom-left" />
        </DraggableCore>,
        <DraggableCore
          {...draggableOpts}
          key="resizableHandle-bottom-right"
          onStop={this.resizeHandler('onResizeStop')}
          onStart={this.resizeHandler('onResizeStart')}
          onDrag={this.resizeHandler('onResize', 'bottom-right')}
          >
          <span className="react-resizable-handle resize-bottom-right" />
        </DraggableCore>
      ]
    });
  }
